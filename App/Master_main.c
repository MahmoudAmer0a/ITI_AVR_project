...
BaseType_t xReturnedTaskOne, xReturnedTaskTwo, xReturnedTaskThree;
TaskHandle_t xHandleTaskOne = NULL;
...
void main(){
	...
	xReturnedTaskThree = xTaskCreate(Door,"Door",configMINIMAL_STACK_SIZE,NULL,1,NULL);
